            ...
            <div className="flex items-center justify-between md:justify-start gap-4">
              <div className="flex items-center gap-4">
                <div className="relative">
                  ...
                  <div className="absolute -bottom-1 -right-1 sm:-bottom-2 sm:-right-2 w-4 h-4 sm:w-6 sm:h-6 bg-emerald-500 rounded-full border-2 border-white flex items-center justify-center">
              ...
              <button
                ...
                className="p-2 md:hidden hover:bg-white/10 rounded-lg transition-colors"
              >
        ...
        <div className="flex flex-col lg:flex-row gap-6 sm:gap-8">
          ...
          <div className={`lg:w-1/4 fixed lg:static top-0 left-0 h-full lg:h-auto z-50 transform transition-transform duration-300 ${
            ...
            <div className="bg-white rounded-none lg:rounded-xl shadow-lg lg:shadow-xl border border-[#d97706]/20 overflow-hidden h-full lg:h-auto">
              ...
              {/* Account Status */}
              <div className="p-4 sm:p-6 border-t border-[#d97706]/20">
          ...
          <div className="lg:w-3/4">
            ...
            {activeTab === 'dashboard' && (
              <div className="space-y-6">
                {/* Welcome Card */}
                <div className="bg-white rounded-xl shadow-lg border border-[#d97706]/20 p-4 sm:p-6 md:p-8">
                  <div className="flex flex-col sm:flex-row sm:items-center justify-between mb-6">
                    <div className="mb-4 sm:mb-0">
                      <h2 className="text-xl sm:text-2xl font-bold text-gray-900">Welcome back, {user?.name?.split(' ')[0]}! 👋</h2>
                      <p className="text-gray-600 mt-1 text-sm sm:text-base">Here's an overview of your account activity</p>
                    </div>
                  </div>

                  {/* Stats Grid */}
                  <div className="grid grid-cols-2 md:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6 mb-8">
                    <div className="bg-gradient-to-r from-[#d97706]/5 to-[#d97706]/10 border border-[#d97706]/20 rounded-xl p-4 sm:p-6">
                      <div className="flex items-center justify-between mb-3 sm:mb-4">
                        ...
                        <div className="text-2xl sm:text-3xl font-bold text-[#d97706]">{userStats.totalOrders}</div>
                      </div>
                    ...
                    <div className="bg-gradient-to-r from-[#d97706]/5 to-[#d97706]/10 border border-[#d97706]/20 rounded-xl p-4 sm:p-6">
                      <div className="flex items-center justify-between mb-3 sm:mb-4">
                        ...
                        <div className="text-2xl sm:text-3xl font-bold text-[#d97706]">{userStats.pendingOrders}</div>
                      </div>
                    ...
                    <div className="col-span-2 md:col-span-1 bg-gradient-to-r from-emerald-50 to-green-50 border border-emerald-200 rounded-xl p-4 sm:p-6">
                      <div className="flex items-center justify-between mb-3 sm:mb-4">
                        ...
                        <div className="text-2xl sm:text-3xl font-bold text-emerald-600">{userStats.completedOrders}</div>
                      </div>
                      <h3 className="font-semibold text-gray-700 mb-1 text-sm sm:text-base">Completed</h3>
                      <p className="text-xs sm:text-sm text-emerald-600">Delivered orders</p>
                    </div>
                  </div>
                    ...
                    {orders.length === 0 ? (
                      <div className="text-center py-8 sm:py-12">
                        <div className="w-12 h-12 sm:w-16 sm:h-16 bg-[#d97706]/10 rounded-full flex items-center justify-center mx-auto mb-4">
                          <FaShoppingBag className="text-[#d97706]/60 text-lg sm:text-xl" />
                        </div>
                      ...
                      <div className="space-y-3 sm:space-y-4">
                        {orders.slice(0, 3).map((order) => (
                          <div key={order._id} className="border border-[#d97706]/20 rounded-lg p-3 sm:p-4 hover:bg-[#d97706]/5 transition-colors">
                            <div className="flex flex-col sm:flex-row sm:items-center justify-between mb-2 sm:mb-3 gap-2">
                              <div className="flex items-center gap-2 sm:gap-4">
                                <div className="font-medium text-gray-900 text-sm sm:text-base">Order #{order._id.slice(-8).toUpperCase()}</div>
                ...
                <div className="bg-white rounded-xl shadow-lg border border-[#d97706]/20 p-4 sm:p-6 md:p-8">
                  <div className="flex flex-col sm:flex-row sm:items-center justify-between mb-6 sm:mb-8 gap-4">
                    <div className="flex items-center gap-3 sm:gap-4">
                      <div className="p-2.5 sm:p-3 bg-[#d97706]/10 rounded-lg">
                        <FaBox className="text-[#d97706] text-lg sm:text-xl" />
                      </div>
                      <div>
                        <h2 className="text-xl sm:text-2xl font-bold text-gray-900">Order History</h2>
                        <p className="text-gray-600 mt-1 text-sm sm:text-base">Track and manage your purchases</p>
                      </div>
                    </div>
                  ...
                  {loading ? (
                    <div className="py-12 sm:py-16 flex flex-col items-center justify-center">
                      <div className="w-10 h-10 sm:w-12 sm:h-12 border-4 border-[#d97706] border-t-transparent rounded-full animate-spin mb-4"></div>
                      <p className="text-gray-500 font-medium">Loading orders...</p>
                    </div>
                  ) : filteredOrders.length === 0 ? (
                    <div className="py-12 sm:py-20 text-center">
                      <div className="w-16 h-16 sm:w-24 sm:h-24 bg-gradient-to-br from-[#d97706]/5 to-[#d97706]/10 rounded-full flex items-center justify-center mx-auto mb-4 sm:mb-6 border border-[#d97706]/20">
                        <FaBox className="text-xl sm:text-3xl text-[#d97706]/60" />
                      </div>
                      ...
                      <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 justify-center">
                        ...
                        {statusFilter !== 'all' && (
                          <button
                            ...
                            className="inline-flex items-center justify-center gap-2 border border-[#d97706] text-[#d97706] px-4 py-3 sm:px-6 sm:py-3.5 rounded-lg font-medium hover:bg-[#d97706]/10 transition-colors text-sm sm:text-base"
                          >
                            <FaFilter />
                            Show All Orders
                          </button>
                    ...
                    <div className="space-y-4 sm:space-y-6">
                      {filteredOrders.map((order) => (
                        <div key={order._id} className="border border-[#d97706]/20 rounded-xl overflow-hidden hover:shadow-lg transition-shadow hover:border-[#d97706]">
                          {/* Order Header */}
                          <div className="bg-gradient-to-r from-[#d97706]/5 to-[#d97706]/10 px-4 sm:px-6 py-3 sm:py-4 border-b border-[#d97706]/20">
                            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3">
                              <div className="flex flex-wrap items-center gap-3 sm:gap-6">
                                <div>
                                  <div className="text-xs font-medium text-[#d97706] uppercase tracking-wider mb-1">Order #</div>
                                  <div className="font-mono font-bold text-[#d97706] text-sm sm:text-base">#{order._id.slice(-8).toUpperCase()}</div>
                                </div>
                                <div>
              ...
              <div className="space-y-6 sm:space-y-8">
                ...
                <div className="bg-white rounded-xl shadow-lg border border-[#d97706]/20 p-4 sm:p-6 md:p-8">
                  <div className="flex items-center gap-3 mb-6 sm:mb-8">
                    <div className="p-2.5 sm:p-3 bg-[#d97706]/10 rounded-lg">
                      <FaUserCircle className="text-[#d97706] text-lg sm:text-xl" />
                    </div>
                    <div>
                  ...
                  {success && (
                    <div className="mb-4 sm:mb-6 p-3 sm:p-4 bg-emerald-50 text-emerald-700 rounded-lg border border-emerald-200">
                  ...
                  {error && (
                    <div className="mb-4 sm:mb-6 p-3 sm:p-4 bg-red-50 text-red-700 rounded-lg border border-red-200">
                      <div className="flex items-center gap-2 sm:gap-3">
                  ...
                  <form onSubmit={handleUpdateProfile} className="space-y-4 sm:space-y-6">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6">
                      <div>
                        ...
                        <div className="relative">
                          ...
                          <input
                            ...
                            className="w-full pl-10 pr-4 py-2.5 sm:py-3 border border-[#d97706] rounded-lg focus:outline-none focus:ring-2 focus:ring-[#d97706] focus:border-[#d97706] transition-all bg-white text-sm sm:text-base"
                      ...
                      <div className="md:col-span-2">
                        ...
                        <div className="relative">
                          <div className="absolute left-3 top-3 sm:top-4 text-[#d97706]">
                            <FaHome />
                          </div>
                          <textarea
                            rows={3}
                            ...
                            className="w-full pl-10 pr-4 py-2.5 sm:py-3 border border-[#d97706] rounded-lg focus:outline-none focus:ring-2 focus:ring-[#d97706] focus:border-[#d97706] transition-all bg-white resize-none text-sm sm:text-base"
                    ...
                    <div className="flex flex-col sm:flex-row items-center justify-between pt-4 sm:pt-6 border-t border-[#d97706]/20 gap-4">
                      <button
                        ...
                        className="w-full sm:w-auto px-4 py-2.5 sm:px-6 sm:py-3 border border-[#d97706] text-[#d97706] font-medium rounded-lg hover:bg-[#d97706]/10 transition-colors text-sm sm:text-base"
                      >
                        Cancel
                      </button>
                      <button
                        type="submit"
                        disabled={loading}
                        className="w-full sm:w-auto px-6 py-2.5 sm:px-8 sm:py-3 bg-[#d97706] text-white font-medium rounded-lg hover:bg-[#b45309] transition-colors disabled:opacity-50 disabled:cursor-not-allowed text-sm sm:text-base"
                      >
                        {loading ? (
                ...
                <div className="bg-white rounded-xl shadow-lg border border-[#d97706]/20 p-4 sm:p-6 md:p-8">
                  <div className="flex items-center gap-3 mb-6 sm:mb-8">
                    <div className="p-2.5 sm:p-3 bg-red-100 rounded-lg">
                      <FaLock className="text-red-600 text-lg sm:text-xl" />
                    </div>
                    <div>
                      <h2 className="text-xl sm:text-2xl font-bold text-gray-900">Change Password</h2>
                      <p className="text-gray-500 text-sm sm:text-base">Update your password for enhanced security</p>
                    </div>
                  </div>

                  <form onSubmit={handleChangePassword} className="space-y-4 sm:space-y-6 max-w-2xl">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6">
                      <div>
                        <label className="block text-sm font-medium text-gray-700 mb-2">
                          Current Password
            ...
            {/* Wishlist Tab */}
            {activeTab === 'wishlist' && (
              <div className="bg-white rounded-xl shadow-lg border border-[#d97706]/20 p-8 sm:p-12 md:p-16 text-center">
                <div className="w-16 h-16 sm:w-20 sm:h-20 bg-gradient-to-r from-[#d97706]/10 to-[#d97706]/20 rounded-full flex items-center justify-center mx-auto mb-4 sm:mb-6 border border-[#d97706]/20">
                  <FaHeart className="text-2xl sm:text-3xl text-[#d97706]" />
                </div>
                <h3 className="text-xl sm:text-2xl font-bold text-gray-900 mb-3">Your Wishlist</h3>
            ...
            {activeTab !== 'dashboard' && activeTab !== 'orders' && activeTab !== 'profile' && activeTab !== 'wishlist' && (
              <div className="bg-white rounded-xl shadow-lg border border-[#d97706]/20 p-8 sm:p-12 md:p-16 text-center">
                <div className="w-16 h-16 sm:w-20 sm:h-20 bg-gradient-to-r from-[#d97706]/10 to-[#d97706]/20 rounded-full flex items-center justify-center mx-auto mb-4 sm:mb-6 border border-[#d97706]/20">
                  <FaCog className="text-2xl sm:text-3xl text-[#d97706] animate-spin" />
                </div>
